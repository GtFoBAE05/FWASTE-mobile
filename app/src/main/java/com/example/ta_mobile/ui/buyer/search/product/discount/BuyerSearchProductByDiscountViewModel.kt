...
class BuyerSearchProductByDiscountViewModel(private val buyerRepository: BuyerRepository) : ViewModel() {
    ...
    fun searchProductResult(keyword:String){
        viewModelScope.launch {
            buyerRepository.searchProductByDiscount(keyword).collect{
